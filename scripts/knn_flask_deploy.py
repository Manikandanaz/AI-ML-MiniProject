...
# Step 2: Scale only the billing_amount column
scaler = MinMaxScaler(feature_range=(0, 1))
#onehot_df['billing_amount'] = scaler.fit_transform(onehot_df[['billing_amount','age']])
...
# Fit the scaler on the entire feature set and transform

X_scaled = scaler.fit_transform(X)

# Step 3: Split into train and test sets
X_train, X_test, y_train, y_test = train_test_split(X_scaled, y, test_size=0.2, random_state=42,stratify=y)
print("Features and target split into train and test sets successfully", X_train.shape)
